...
$(document).ready(function () {
    ...
    $('.company_tpv').hide();
    $('.company_count').hide();
    $('.company_tpv_hourly').hide();
    $('.company_count_hourly').hide();
    $('.company_paper_statements').hide();
    $('.company_emails').hide();
    $('.company_tpv_all').css('display', '');
    $('.company_count_all').css('display', '');
    $('.company_tpv_hourly_all').css('display', '');
    $('.company_count_hourly_all').css('display', '');
    $('.company_paper_statements_all').css('display', '');
    $('.company_emails_total_all').css('display', '');
    ...
    $('#companies').on('change',function () {
      ...
      var email_category = $('#email_categories').val();
      $(".company_tpv_"+company_name).css('display', '');
      $(".company_count_"+company_name).css('display', '');
      $(".company_tpv_hourly_"+company_name).css('display', '');
      $(".company_count_hourly_"+company_name).css('display', '');
      $(".company_paper_statements_"+company_name).css('display', '');
      $('.company_emails_'+email_category+'_'+company_name).css('display', '');
    });
    $('#email_categories').on('change',function () {
      $('.company_emails').hide();
      var email_category = $(this).val();
      var company_name = $('#companies').val();
      $('.company_emails_'+email_category+'_'+company_name).css('display', '');
    });
});
