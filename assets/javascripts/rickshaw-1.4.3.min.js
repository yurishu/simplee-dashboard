...
$(document).ready(function () {
    ...
    $('#companies').on('change',function () {
      ...
      $('.company_paper_statements').hide();
      var val = $(this).val();
      $(".company_tpv_"+val).css('display', '');
      $(".company_count_"+val).css('display', '');
      $(".company_tpv_hourly_"+val).css('display', '');
      $(".company_count_hourly_"+val).css('display', '');
      $(".company_paper_statements_"+val).css('display', '');
    });
});
